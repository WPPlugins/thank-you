	...
	class ThankYou_Admin
		...
		function config_page()
			...
			<div class="wrap">
				...
				<p style="margin-top: 35px;">The author of the plugin is <a href="http://xn--wicek-k0a.pl/">Łukasz Więcek</a>. <strong>Thank You</strong> plug was written on the basis of plug <strong>Comment Redirect</strong>.</p>
			</div>
			<?php }
		}
	}
...
function replace_redirect($content)
	...
	if(is_page($options))
		...
		$content = $content."<p style='font-size: 10px; color: #666; margin-top: 10px;'>Strona wygenerowana dzięki wtyczke <a href='http://xn--wicek-k0a.pl/projekty/thank-you'>Thank You</a> autorstwa <a href='http://xn--wicek-k0a.pl/'>Łukasza Więcka</a>.</p>";
		}
	return $content;
	}
